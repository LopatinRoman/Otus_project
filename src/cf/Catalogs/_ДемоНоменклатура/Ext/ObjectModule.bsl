...
Процедура ПриЗаписи(Отказ)
    ...
    //ИНГОС_Н Лопатин Р.А. 19.02.2026 USER STORY DEV-1
    Сообщение = Новый СообщениеПользователю;
    Сообщение.Текст = НСтр("DEV-1");
    Сообщение.Сообщить();
    ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Это второй коммит'"));
    //ИНГОС_К Лопатин Р.А. 19.02.2026 USER STORY DEV-1
